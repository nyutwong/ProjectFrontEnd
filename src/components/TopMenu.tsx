                    ...
                    <>
                        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                            <div className="relative flex h-16 items-center justify-between">
                                ...
                                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0  dark:border-slate-500">
                                    <ThemeSwitcher />
                                    <Menu as="div" className="relative lg:border-l lg:border-slate-200 lg:ml-6 lg:pl-6 ml-3">
                                        <div>
